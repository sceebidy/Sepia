      ...
      <div class="item-list">
        ...
        <div class="item-card">
          ...
          <div class="item-actions">
            ...
            @endif
            <form method="POST" action="{{ route('datapool.deleteItem', $item) }}" onsubmit="return confirm('Hapus item ini?')">
              @csrf @method('DELETE')
...
<div class="modal-overlay" id="modal-overlay" onclick="closeModal(event)">
  <div class="modal">
    ...
    <form method="POST" action="{{ route('datapool.addItem', $folder) }}" enctype="multipart/form-data">
      @csrf
      ...
      <div class="field-group" id="field-link">
        <div class="form-group">
          ...
          <input class="form-input" type="url" name="konten" placeholder="https://..." />
        </div>
      </div>
      ...
      <div class="field-group" id="field-catatan">
        <div class="form-group">
          ...
          <textarea class="form-textarea" name="konten" placeholder="Tulis catatan..."></textarea>
        </div>
      </div>
